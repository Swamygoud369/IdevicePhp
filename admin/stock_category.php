...
//     $check_products = $conn->query("SELECT COUNT(*) FROM products WHERE category_id = $id");
//     $product_count = $check_products->fetch_row()[0];

//     if ($product_count > 0) {
//         $message = "Cannot delete category - it has associated products!";
//         $message_type = "danger";
//     } else {
//         $delete = $conn->prepare("DELETE FROM device_categories WHERE id=?");
...
if (isset($_POST['delete_category'])) {
    ...
    $check_products = $conn->query("SELECT COUNT(*) FROM device_stockmodels WHERE category_id = $id");
    $model_count = $check_products->fetch_row()[0];
