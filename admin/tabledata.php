                        ...
                        <ul>
                                        ...
                                        <div class="filter-set-view">
                                            ...
                                            <div class="filter-reset-btns">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <a href="leads.html" class="btn btn-primary">Filter</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="view-icons">
                                    <a href="leads.html" class="active"><i class="ti ti-list-tree"></i></a>
                                    <a href="leads-kanban.html"><i class="ti ti-grid-dots"></i></a>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="pro-create">
            <form action="#">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <a href="#" class="add-new add-new-phone mb-3 d-block"><i class="ti ti-square-rounded-plus me-2"></i>Add New</a>
                    </div>
                    <div class="col-md-6">
                        <div class="form-wrap">
                            <label class="col-form-label">Source <span class="text-danger">*</span></label>
        ...
        <div class="modal-body">
            <div class="success-message text-center">
                ...
                <div class="col-lg-12 text-center modal-btn">
                    ...
                    <a href="leads.html" class="btn btn-danger">Yes, Delete it</a>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="form-wrap">
                                            <div class="profile-upload">
                                                <div class="profile-upload-img">
                                                    ...
                                                    <img src="images/icons/company-icon-03.svg" alt="img" class="preview1">
