...
if (isset($_POST['save_model'])) {
    ...
    if ($mid) {
        $conn->query("UPDATE device_models SET model_name='$model' WHERE id=$mid");
        $redirect_id = $mid;
    } else {
 ...
 header("Location: ".$_SERVER['PHP_SELF']);
    // header("Location: device_models.php?category_id=$cid");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_model'])) {
  ...
  $sql = "DELETE FROM device_models WHERE id = $id";
                ...
                <form method="POST">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="model_name" placeholder="Model (e.g. iPhone 15)" class="form-control" required value="<?= $edit_model['model_name'] ?? '' ?>">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="table-responsive custom-table">
                            <table class="table" id="booking_list">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT m.id, m.model_name, m.category_id, c.category_name 
                                    ...
                                    while ($row = $res->fetch_assoc()) {
                                        echo "<tr>
                                                ...
                                                <td>
                                                    <a href='device_models.php?id={$row['id']}' class='btn btn-sm btn-warning'>Edit</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="success-message text-center">
          ...
          <h3>Delete Model?</h3>
          <p class="del-info">
            Are you sure you want to delete <strong id="modelNameText">this model</strong>?
          </p>
...
<script>
  ...
  error: function (xhr, status, error) {
    ...
    alert('Something went wrong while deleting.');
      ...
      //         const row = $('#confirmDeleteBtn').data('row');
      ...
      //       }
      //     } catch (e) {
      //       console.error('Delete failed: Invalid response', res);
